...
CONTAINER_NAME="fastapi-app"                 # Nom du conteneur
ACR_NAME="kaassiregistry"            # Nom de ton Azure Container Registry
REGION="francecentral"           # Région où tu souhaites déployer
IMAGE_NAME="fastapi-app"                   # Nom de l'image Docker
DNS_LABEL="kaassi"                 # Label DNS pour accéder au conteneur
